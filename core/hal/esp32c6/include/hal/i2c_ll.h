...
#define I2C_SLEEP_RETENTION_MODULE(i2c_num) (SLEEP_RETENTION_MODULE_I2C0)
     ...
     * @return None
     */
    __attribute__((always_inline)) static inline void i2c_ll_update(i2c_dev_t *hw)
    {
     ...
     * @return None
     */
    __attribute__((always_inline)) static inline void i2c_ll_txfifo_rst(i2c_dev_t *hw)
    {
     ...
     * @return None
     */
    __attribute__((always_inline)) static inline void i2c_ll_rxfifo_rst(i2c_dev_t *hw)
    {
     ...
     * @return None
     */
    __attribute__((always_inline)) static inline void i2c_ll_clear_intr_mask(i2c_dev_t *hw, uint32_t mask)
    {
        hw->int_clr.val = mask;
    }
     ...
     * @return None
     */
    __attribute__((always_inline)) static inline void i2c_ll_enable_intr_mask(i2c_dev_t *hw, uint32_t mask)
    {
        hw->int_ena.val |= mask;
    }
     ...
     * @return None
     */
    __attribute__((always_inline)) static inline void i2c_ll_disable_intr_mask(i2c_dev_t *hw, uint32_t mask)
    {
        hw->int_ena.val &= (~mask);
    }
     ...
     */
    __attribute__((always_inline)) static inline void i2c_ll_get_intr_mask(i2c_dev_t *hw, uint32_t *intr_status)
    {
     ...
     * @return None
     */
    __attribute__((always_inline)) static inline void i2c_ll_slave_get_stretch_cause(i2c_dev_t *hw, i2c_slave_stretch_cause_t *stretch_cause)
    {
     ...
     * @return None
     */
    __attribute__((always_inline)) static inline void i2c_ll_master_write_cmd_reg(i2c_dev_t *hw, i2c_ll_hw_cmd_t cmd, int cmd_idx)
    {
     ...
     */
    __attribute__((always_inline)) static inline bool i2c_ll_is_bus_busy(i2c_dev_t *hw)
    {
     ...
     */
    __attribute__((always_inline)) static inline void i2c_ll_get_rxfifo_cnt(i2c_dev_t *hw, uint32_t *length)
    {
     ...
     */
    __attribute__((always_inline)) static inline void i2c_ll_get_txfifo_len(i2c_dev_t *hw, uint32_t *length)
    {
     ...
     * @return None
     */
    __attribute__((always_inline)) static inline void i2c_ll_master_trans_start(i2c_dev_t *hw)
    {
     ...
     * @return None.
     */
    __attribute__((always_inline)) static inline void i2c_ll_write_txfifo(i2c_dev_t *hw, const uint8_t *ptr, uint8_t len)
    {
        for (int i = 0; i < len; i++)
        {
     ...
     * @return None
     */
    __attribute__((always_inline)) static inline void i2c_ll_read_rxfifo(i2c_dev_t *hw, uint8_t *ptr, uint8_t len)
    {
        for (int i = 0; i < len; i++)
        {
    ...
    {
        hw->fifo_conf.nonfifo_en = addr_wr_en;
    }
...
#define lp_i2c_ll_set_source_clk(...) \
...
#define lp_i2c_ll_enable_bus_clock(...) \
    (void)__DECLARE_RCC_ATOMIC_ENV;     \
...
#define lp_i2c_ll_reset_register(...) \
    (void)__DECLARE_RCC_ATOMIC_ENV;   \
     ...
     * @param dev Beginning address of the peripheral registers
     */
    __attribute__((always_inline)) static inline void i2c_ll_slave_clear_stretch(i2c_dev_t *dev)
    {
     ...
     */
    __attribute__((always_inline)) static inline bool i2c_ll_master_is_cmd_done(i2c_dev_t *hw, int cmd_idx)
    {
...
#define I2C_LL_INTR_MASK (0x3fff) /*!< I2C all interrupt bitmap */
     ...
     * @return None
     */
    __attribute__((always_inline)) static inline void i2c_ll_master_get_event(i2c_dev_t *hw, i2c_intr_event_t *event)
    {
     ...
     * @return None
     */
    __attribute__((always_inline)) static inline void i2c_ll_slave_get_event(i2c_dev_t *hw, i2c_intr_event_t *event)
    {
     ...
     * @return None
     */
    __attribute__((always_inline)) static inline void i2c_ll_master_enable_tx_it(i2c_dev_t *hw)
    {
     ...
     * @return None
     */
    __attribute__((always_inline)) static inline void i2c_ll_master_enable_rx_it(i2c_dev_t *hw)
    {
        hw->int_clr.val = UINT32_MAX;
     ...
     * @return None
     */
    __attribute__((always_inline)) static inline void i2c_ll_master_disable_rx_it(i2c_dev_t *hw)
    {
        hw->int_ena.val &= (~I2C_LL_MASTER_RX_INT);
    }
     ...
     * @return None
     */
    __attribute__((always_inline)) static inline void i2c_ll_slave_disable_tx_it(i2c_dev_t *hw)
    {
        hw->int_ena.val &= (~I2C_LL_SLAVE_TX_INT);
    }
